  ...
  return (
    <div className="bg-white border border-gray-300 shadow-md shadow-gray-300 overflow-hidden flex flex-col">
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <Link href={"/blogs/"+slug} locale={locale} className="mt-4 bg-blue-500 hover:bg-blue-700 transition-colors duration-200 ease-in-out text-white text-center font-bold py-2 px-4 text-sm hover:cursor-pointer">
          Read More
        </Link>
      </div>
    </div>
